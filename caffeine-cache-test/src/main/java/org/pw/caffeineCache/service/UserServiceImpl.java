...
public class UserServiceImpl {
    ...
    //查询时存入缓存
    @Cacheable(cacheManager = "commonCacheManager", cacheNames = "users", key = "'user'+#id")
    ...
    //更新方法，更新缓存
    @CachePut(cacheManager = "commonCacheManager", cacheNames = "users", key = "'user'+#id")
    ...
    //删除时废弃缓存
    @CacheEvict(cacheManager = "commonCacheManager", cacheNames = "users", key = "'user'+#id")
